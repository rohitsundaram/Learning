...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileChangeBtn=findViewById(R.id.change_picture_button);
        ...
        closeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(getType.equals("Drivers"))
                {
                    startActivity(new Intent(SettingsActivity.this,MapsActivityDriver.class));
                }

                else
                {
                    startActivity(new Intent(SettingsActivity.this,MapsActivityCustomer.class));
                }
            }
        });
